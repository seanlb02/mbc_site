          ...
          <section id="header" className={styles.main}>
            <div className="flex flex-col items-center w-1/4 border-r border-black p-4 text-left">
              <div className="flex flex-col text-left flex-start w-full text-sm">
                Bio or something here<br></br>Quis laborum ea exercitation
                labore ea eiusmod ipsum. <b></b>
                <n></n>
                Dolor nostrud sint eiusmod dolore ea. Irure eiusmod incididunt
                occaecat excepteur eiusmod ad voluptate cillum.
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 w-1/4 border-l border-black p-4 text-left">
              ...
              <div className="flex mx-auto h-fit w-4/5 items-start">
                ...
                <div className="flex w-1/2 text-xs items-center ">
                  Thursday - Sunday
                  <br></br>12-pm till Late-pm.
                </div>
              </div>
              ...
              <icons className="flex w-4/5 mx-auto  h-fit items-center  gap-6 pt-1">
                <socialIcon>
                  <a
                    className="fa fa-facebook fa-2x hover:fa-3x"
                    href="https://github.com/seanlb02"
                    target="_blank"
                  ></a>
                </socialIcon>
                <socialIcon>
                  <a
                    ...
                    href="https://www.linkedin.com/in/sean-gyuris-72b5a1127/ "
                    target="_blank"
                  ></a>
                </socialIcon>
                <socialIcon>
                  <a
                    ...
                    href="https://soundcloud.com/cult-trip-records"
                    target="_blank"
                  ></a>
                </socialIcon>
              </icons>
...
const styles = {
  pageContainer:
    " flex flex-col items-center  z-0 top-0 h-52 m-10 mb-5 border border-black font-mono cursor-logo bg-white",
