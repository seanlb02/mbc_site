        ...
        <>
            ...
            <div className={styles.NavContainer}>
                <div className="text-sm bg-transparent w-[100vw] flex m-auto pl-6 gap-24 p-2">
                    <div className="flex bg-transparent text-xs text-white " onClick={() => setVenueShow(!venueShow)}><u>menu</u></div>
                ...
                <div id="nav" className={styles.itemContainer}>
                    ...
                    <div className="flex  pl-4 py-3" onClick={()=> Router.push('/venues')}>Venues</div>
...
const styles = {
    ...
    itemContainer: " bg-white border border-black flex flex-col align-start mb-5 m-10 mt-3 mb-0 border h-fit",
