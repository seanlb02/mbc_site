  ...
  return (
    <>
      <div className={styles.NavContainer}>
        <div
          className="items-center w-[100vw] h-[24] sticky top-0 bg-white flex justify-center"
          onClick={() => Router.push("/")}
        >
          <Image
            height={80}
            width={200}
            src={"/MBC_logo.png"}
            className="flex items-center h-[20] w-[80vw]"
          ></Image>
        </div>
...
const styles = {
  ...
  itemContainer:
    " bg-white border border-black flex flex-col align-start  m-10 mt-3 mb-0 border h-fit",
