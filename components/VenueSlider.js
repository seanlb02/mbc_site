...
export default function VenueSlider(){
    ...
    <div className="h-[100vh] no-scrollbar">
        ...
        { width < 700 ?             
            ...
            <div className="flex flex-col lg:border-l border-l-black overflow-y-scroll no-scrollbar mx-5 bg-white lg:h-[100vh] h-fit lg:w-3/4 w-full z-0 lg:ml-10 lg:animate-blurin items-center">
            
            
            <div className="flex flex-col h-fit bg-white  lg:ml-5 lg:mr-5 m-0 z-0 "> 
                <div className="flex text-2xl lg:text-5xl h-fit w-full ml-0 lg:ml-5 lg:mt-10 md:mt-10 md:text-3xl">{venueSpotlight}</div>
                ...
                <div className="flex text-sm lg:text-lg mb-10 lg:mx-5">This is a paragraph about the venue,  Dolor nostrud sint eiusmod dolore ea. Irure eiusmod incididunt occaecat excepteur eiusmod ad voluptate cillum. Dolor nostrud sint eiusmod dolore ea. Irure eiusmod incididunt occaecat excepteur eiusmod ad voluptate cillum.</div>
            </div>
                    ...
                    <div className="min-h-[80vh] max-h-[80vh] p-2 no-scrollbar mb-5 w-full lg:w-3/5 border-2 border-black overflow-y-scroll" dangerouslySetInnerHTML={{ __html: thegreatclub }}></div>
                    :
                    ...
                    <div className="min-h-[80vh] w-full lg:w-3/5 no-scrollbar mb-5 border-2 border-black overflow-y-scroll" dangerouslySetInnerHTML={{ __html: chippo }}></div>
                    :
                    ...
                    <div className="min-h-[80vh] w-full lg:w-3/5 no-scrollbar mb-5 border-2 border-black overflow-y-scroll" dangerouslySetInnerHTML={{ __html: waywards }}></div>
                    :
                    <div className="hidden h-[100vh] w-full lg:w-3/5 border-2 border-black overflow-y-scroll" dangerouslySetInnerHTML={{ __html: waywards }}></div>
                    }
            </div>  
