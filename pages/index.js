    ...
    <main className={styles.pageContainer}>
        ...
        <div className="relative h-[100vh] w-[100vw] ">
          ...
          {rearrange ? 
            ...
            {width < 700 ? <div id="cube" className="flex flex-row max-h-36   bg-white z-40 bottom-16 left-0 right-0 text-center absolute mb-2 m-10 lg:mt-12 py-8 px-2 border border-black text-center text-xs">
                  {fade ? <div onClick={()=> setFade(!fade)}  className={`flex ${fade ? "animate-fadein" : "animate-fadeout"} flex-auto  overflow-x-scroll no-scrollbar max-h-36`}>
                  ...
                  <div onClick={()=> setFade(!fade)} className="flex animate-fadein overflow-x-scroll no-scrollbar">Something else entirasdssdfsdfsdfsdfsdfsdely </div>}
              </div> : <></>}
