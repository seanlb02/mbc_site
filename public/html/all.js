const htmlString = `<html>
    ...
    <script type="text/javascript">
        ...
        const venue_filter='Venue.Name:"Waywards (The Bank Hotel)" OR Venue.Name:"Paddo Lounge (Paddington RSL)" OR Venue.Name:"The Chippo Hotel" OR Venue.Name:"Vic on The Park Hotel" OR Venue.Name:"The Royal Bondi" OR Venue.Name:"Golden Age Cinema & Bar" OR Venue.Name:"The Great Club" OR Venue.Name:"The House of Music & Booze"'
    </script>
    ...
    <!-- START ALGOLIA -->
      <div class="algolia-search"> 
            ...
            var search = instantsearch({
                ...
                searchParameters: {
                    ...
                    facetsRefinements:{
                        ...
                        // 'EventGuid': ["239a58b9-d23e-466c-95f7-ccd568d19852"],	// -- hide 1 or more events from your feed using a hypen then the event GUID copied from the URL of the required event.
                    ...
                    disjunctiveFacetsRefinements:{ 
                        ...
                        // 'EventGuid':["239a58b9-d23e-466c-95f7-ccd568d19852"]
                        },
                    },
            });
        ...
        var facetTemplateCheckbox =
            ...
            '<input type="checkbox" class="{{cssClasses.checkbox}}" styles="display:none" value="{{name}}" {{#isRefined}}checked{{/isRefined}} />{{name}}' +
            '</a>';
                ...
                transformData: {
                    item: function(hit) {
                        ...
                        let params = new URLSearchParams(url.search)
                            params.set('utm_source', 'MusicAndBooze-AllVenues')
